...
See
* Baird, S., Homer, E., Fullwood, T., & Johnson, O. (2021). Five Degree-of-Freedom Property Interpolation of Arbitrary Grain Boundaries via Voronoi Fundamental Zone Octonion Framework. (Submitted and soon to be available on ArXiv, citation available soon. Planning to submit to Computational Materials Science)
