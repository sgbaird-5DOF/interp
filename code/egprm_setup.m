function [ypred,interpfn,mdl,mdlpars] = egprm_setup(ninputpts,npredpts,method,datatype,epsijk,NV)
arguments
    ninputpts
    npredpts
    method char = 'gpr'
...
errmetrics = get_errmetrics(ypred,ytrue);
...
mdlpre = var_names(datatype,ninputpts,npredpts);
mdlparspre = var_names(datatype,ninputpts,npredpts);
...
%             'pgnum',pgnum,'uuid',uuid,'ytrue',ytrue,'brkQ',brkQ,'sigma',sigma,'o',o,'o2',o2);
%     end
%     ypredtmp = [ypredlist{:}];
