...
meshopts.ocuboOpts.n = 5000; % # of octonions to generate, [] also ok if sidelength specified
...
dataopts.ocuboOpts.n = 1000; % # of octonions to generate, [] also ok if sidelength specified
