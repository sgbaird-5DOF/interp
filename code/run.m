...
% 		psdata.five(i) = pseudo.five(nnList2);
    ...
    %this computation can take a while, so probably worth saving
    tol = 1e-3;
    tol2 = 1e-4;
    ...
    %intfacetIDs = intersect_facet(mesh.pts,mesh.sphK,psdata.pts,tol);
...
scatter(data.props,datainterp,10,'k','filled','markerfacealpha',0.01);
hold on
% axis tight
scatter(data.props(ilist),mesh.props(nnID),10,'r','filled','markerfacealpha',0.01);
