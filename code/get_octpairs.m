...
%--------------------------HELPER FUNCTIONS--------------------------------
function [o3_out,omega3,omega3_GBdist,varargout] = GBpair(o1,o2,o3,varargin)
%--------------------------------------------------------------------------
% Author: Sterling Baird
%
% Date: 2020-07-17
...
switch method
	case 1
		...
		%calculate distances
		[omega1,oct_sym1,zeta1,wveclist1,octonion_pair_sym_list1] = GBdist2([o1 o3],32,false);
		[omega2,oct_sym2,zeta2,wveclist2,octonion_pair_sym_list2] = GBdist2([o2 o3],32,false);
		
	case 2
		%both with respect to o1, output o2 and o3
		
		%calculate distances
		[omega1,oct_sym1,zeta1,wveclist1,octonion_pair_sym_list1] = GBdist2([o1 o2],32,false);
		[omega2,oct_sym2,zeta2,wveclist2,octonion_pair_sym_list2] = GBdist2([o1 o3],32,false);
end
