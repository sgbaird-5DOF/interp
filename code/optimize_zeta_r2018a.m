function [xopt, fopt, exitflag, output] = optimize_zeta_r2018a(o,dtype,z0)
% arguments
...
%objective function
errtype = 'me'; %'me','rmse','se','mse'
disp(['errtype == ' errtype])
obj = {@(z) pd_sse_r2018a(o,z,dtype,pdtrue,function_handle.empty,errtype)};

%minimization
opttype = 'ga';
disp(['opttype == ' opttype])
switch opttype
    case 'fmincon'
...
%         opts = optimoptions('ga','Display','iter');
        ...
        [xopt, fopt, exitflag, output] = ga(obj,npts,A,b,Aeq,beq,lb,ub,nlc,opts);
end
