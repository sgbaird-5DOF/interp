function [omega_new, oct_new, zeta_new,wveclist,octonion_pair_sym_list] = GBdistdis(data,pgnum,genplot)
...
data(:,1:8) = sqrt2norm(data(:,1:8)); % 2020-07-21 SGB
data(:,9:16) = sqrt2norm(data(:,9:16)); % 2020-07-21 SGB
                ...
                for l = 1:npt
                    ...
                    octonion_pair_sym = [qSA qSB qCz1 qDz1;
                          ...
                          -qSB -qSA qCs2 qDs2]; %symmetrically equivalent candidate octonion pairs
							...
							octonion_pair_sym_list = [octonion_pair_sym_list; octonion_pair_sym];
...
%                         min_rep_zeta(min_rep_count) = zeta_keep;
                        ...
                        if min_rep_count > 9 %if min angle is repeated nine times, exit symmetry loop %modified 2020-07-14 SGB
