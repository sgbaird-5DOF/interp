...
assert(abs(norm(data(1,1:8))-sqrt(2)) < 1e-6,'norm(data(1,1:8)) ~= sqrt(2)') %2020-07-21 SGB
assert(abs(norm(data(1,9:16))-sqrt(2)) < 1e-6,'norm(data(1,9:16)) ~= sqrt(2)') %2020-07-21 SGB
