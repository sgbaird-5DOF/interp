function [octvtx,usv,five,omega3] = get_octpairs_r2018a(pts,savename,NV)
% arguments
...
[omega0,oct_sym0] = GBdist4_r2018a(o1,o2,32,'norm',NV.wtol);
...
for i = 1:npts %parfor compatible
	...
	o3 = pts(i,:); %input
	[octvtx{i+1},omega3(i+1)] = GBpair_r2018a(o1,o2,o3,NV.pgnum,NV.method,NV.wtol);
end
disp(' ')
...
five = GBoct2five_r2018a(octvtx,true);
...
NV.nforceQ = false;
NV.zeroQ = true;
[octvtx2,usv] = proj_down_r2018a(octvtx,tol,usv,NV);
