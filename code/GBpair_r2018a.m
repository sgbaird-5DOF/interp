function [o3_out,omega3,o2_out] = GBpair_r2018a(o1,o2,o3,pgnum,method,wtol)
% arguments
...
switch method
	case 'standard'
		...
		%calculate distances
		[omega1, minsyms1] = GBdist4_r2018a(o1,o3,pgnum,'omega',1e-6);
		[omega2, minsyms2] = GBdist4_r2018a(o2,o3,pgnum,'omega',1e-6);
		
	case 'pairwise'
		%both with respect to o1, output o2 and o3
		
		%calculate distances
		[~, minsyms1] = GBdist4_r2018a(o1,o2,pgnum,'norm',1e-6);
		[~, minsyms2] = GBdist4_r2018a(o1,o3,pgnum,'norm',1e-6);
end
...
% 		disp(T);
	...
	case 'pairwise'
		...
		%calculate omega
		wveclist3 = get_omega_r2018a(minsympairs1,minsympairs2);
